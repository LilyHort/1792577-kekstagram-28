...
/**
 * @param {number} perecent
 */
const setScale = (perecent) => {
  picture.style.setProperty('transform', `scale(${perecent / 100})`);
  scaleControl.querySelector('input').setAttribute('value',`${perecent}%`);
};
